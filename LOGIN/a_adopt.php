...
$query = "INSERT INTO pet_adoption (pet_id, user_id, adoptation_date) VALUES ('$animal_id','$user_id', CURDATE())";
    if (mysqli_query($connect, $query) === true) {
        ...
        if (mysqli_query($connect, $query2) === true){
            ...
            $body =$animal_name . "<img style='width:100%; height:500px; object-fit: cover;' src='$animal_picture'>" ."Location: " . $location . "<br>".$animal_name ." will be a cute pet"  ;
        }
        else {
            $class = "danger";
            $tags = '';
