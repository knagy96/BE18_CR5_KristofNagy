<?php
    ...
    foreach($rows as $row) {
        ...
        <img src='.$row["animal_picture"].' class="card-img-top" alt="...">
        <div class="card-body">
          <h5 class="card-title">'.$row["animal_name"].'</h5>
          <hr>
          <p class="card-text">Location : '.$row["location"].'</p>
          <p class="card-text">Description: '.$row["species_of_animal"].'</p>
          <p class="card-text">Age: '.$row["animal_age"].'</p>
          <p class="card-text">Vacinated Status: '.$row["vacinated"].'</p>
